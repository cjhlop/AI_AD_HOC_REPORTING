    ...
    <header className="bg-white border-b border-gray-200 px-6 py-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          <Button variant="ghost" size="icon" className="relative h-9 w-9 text-gray-600">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="flex items-center space-x-2 px-2 h-10">
                ...
                <span className="text-sm font-medium hidden md:inline text-gray-700">Vasyl Admin</span>
                <ChevronDown className="w-4 h-4 hidden md:inline text-gray-500" />
              </Button>
            </DropdownMenuTrigger>
