...
import { CacheSettingsDrawer } from '@/components/CacheSettingsDrawer';
import { 
  Plus, 
  Filter, 
  Calendar, 
...
const Dashboards = () => {
  const [isCacheDrawerOpen, setIsCacheDrawerOpen] = useState(false);
  ...
  return (
    <>
            ...
            <div className="mb-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <Button variant="outline" size="sm" onClick={() => setIsCacheDrawerOpen(true)}>
      ...
      <CacheSettingsDrawer isOpen={isCacheDrawerOpen} onOpenChange={setIsCacheDrawerOpen} />
    </>
  );
};
